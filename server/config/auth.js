...
const auth0Token = ejwt({
    secret: jwks.expressJwtSecret({
        cache: true,
        rateLimit: true,
        jwksRequestsPerMinute: 5,
        jwksUri: 'https://givememymoney.auth0.com/.well-known/jwks.json',
    }),
    audience: process.env.AUTH0_CLIENT_ID,
    issuer: 'https://givememymoney.auth0.com/',
    algorithms: ['RS256'],
});

module.exports = { authenticate, restricted, makeToken, auth0Token };
